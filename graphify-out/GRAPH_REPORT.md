# Graph Report - /Users/songstephen/my-brain  (2026-06-10)

## Corpus Check
- Large corpus: 326 files · ~175,612 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.
