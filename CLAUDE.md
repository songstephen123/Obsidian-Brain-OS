...
Brain OS is your personal knowledge management and operations system. It runs on Obsidian vault + Claude Code as the AI agent.
...
bash ~/.claude/scripts/brain-os-cron-wrapper.sh <task-name> <prompt-file>
