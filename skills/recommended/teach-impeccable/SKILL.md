...
Then ask the user directly to clarify what you cannot infer. whether they'd also like the Design Context appended to .github/copilot-instructions.md. If /Users/songstephen/my-brain, append or update the section there as well.
