...
目标文件：
`/Users/oao/my-brain/01-PERSONAL-OPS/01-DAILY-BRIEFS/daily-briefing.md`
...
11. **知识信号模块（必须包含，不可省略）**：
   - 在 daily-briefing.md 的结构末尾追加模块：`## 九、🧠 昨日知识信号`
   - 内容来源：读昨天的 nightly digest，路径为 `03-KNOWLEDGE/01-READING/04-DIGESTS/nightly-digest-YYYY-MM-DD.md`（YYYY-MM-DD = 昨天日期，Asia/Shanghai 口径）
